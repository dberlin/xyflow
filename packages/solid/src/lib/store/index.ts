...
import { getInitialStore, initialEdgeTypes, initialNodeTypes } from './initial-store';
import { type SolidFlowStore, type SolidFlowStoreActions, type StoreSignals } from './types';

export { useStore } from '../hooks/useStore';

export function createStore(signals: StoreSignals): SolidFlowStore {
  ...
  const storeWithActions = Object.assign(store, {
    ...
    cancelConnection,
    reset,
  } satisfies SolidFlowStoreActions);
