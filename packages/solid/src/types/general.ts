...
import type { Node, Edge, SolidFlowInstance, EdgeProps, NodeProps } from '.';
...
/**
 * When calling [`fitView`](/api-reference/types/solid-flow-instance#fitview) these options
...
export type OnInit<NodeType extends Node = Node, EdgeType extends Edge = Edge> = (
  solidFlowInstance: SolidFlowInstance<NodeType, EdgeType>
) => void;
