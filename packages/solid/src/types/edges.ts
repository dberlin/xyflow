 ...
 * passed to the `defaultEdgeOptions` prop of the [`<SolidFlow />`](/api-reference/solid-flow#defaultedgeoptions) component.
 */
export type DefaultEdgeOptions = DefaultEdgeOptionsBase<Edge>;

export type EdgeTextProps = JSX.SvgSVGAttributes<SVGElement> &
  EdgeLabelOptions & {
    x: number;
    y: number;
  };
 ...
 * @expand
 */
export type BaseEdgeProps = Omit<JSX.SvgSVGAttributes<SVGPathElement>, 'd'> &
  EdgeLabelOptions & {
 ...
 * `connectionLineComponent` prop on the [`<SolidFlow />`](/api-reference/solid-flow#connection-connectionLineComponent)
...
export type ConnectionLineComponent<NodeType extends Node = Node> = Component<ConnectionLineComponentProps<NodeType>>;
