 ...
 * @public
 */
export interface SolidFlowProps<NodeType extends Node = Node, EdgeType extends Edge = Edge>
   ...
   * import SolidFlow, { useNodesState } from '@xyflow/solid';
   ...
   * import SolidFlow, { applyNodeChanges } from '@xyflow/solid';
   *
   ...
   * import SolidFlow, { useEdgesState } from '@xyflow/solid';
   * const [edges, setEdges, onEdgesChange] = useEdgesState(initialEdges);
   *
   * return (<SolidFlow onEdgesChange={onEdgesChange} {...rest} />)
   * @example // Use helper function to update edge
   * import SolidFlow, { applyEdgeChanges } from '@xyflow/solid';
   *
   ...
   * import SolidFlow, { addEdge } from '@xyflow/solid';
   *
   ...
   *
   * Although created edges can be of any type, Solid Flow needs to know what type of path to render for the connection line before the edge is created!
   */
  connectionLineType?: ConnectionLineType;
  /** Styles to be applied to the connection line */
  connectionLineStyle?: JSX.CSSProperties;
  /** Solid Component to be used as a connection line */
   ...
   * but we ask that you take a quick look at our {@link https://solidflow.dev/learn/troubleshooting/remove-attribution | removing attribution guide}
   * before doing so.
   */
