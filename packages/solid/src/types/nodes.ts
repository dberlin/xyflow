...
/**
 * The `Node` type represents everything Solid Flow needs to know about a given node.
...
/**
 * The `BuiltInNode` type represents the built-in node types that are available in Solid Flow.
