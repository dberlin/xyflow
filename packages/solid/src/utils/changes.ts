...
/*
 * This function applies changes to nodes or edges that are triggered by Solid Flow internally.
 * When you drag a node for example, Solid Flow will send a position change update.
...
function applyChanges(changes: any[], elements: any[]): any[] {
  ...
  for (const element of elements) {
     ...
     * object so Solid knows this element has changed. Sequential changes will
 ...
 *import { SolidFlow, applyNodeChanges, type Node, type Edge, type OnNodesChange } from '@xyflow/solid';
 *
